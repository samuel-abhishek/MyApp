...
public class IntroSlice extends AbilitySlice {
    ...
    private void initViews(Intent intent) {
        HiLog.debug(new HiLogLabel(0,0,"IntroSlice"), "SAMUEL initViews");
    ...
    private void initListener() {
        HiLog.debug(new HiLogLabel(0,0,"IntroSlice"), "SAMUEL initListener");
        ...
        appLogo.setBindStateChangedListener(new Component.BindStateChangedListener() {
            ...
            public void onComponentBoundToWindow(Component component) {
                HiLog.debug(new HiLogLabel(0,0,"IntroSlice"), "SAMUEL initListener onComponentBoundToWindow");
